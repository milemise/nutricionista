...
public class DietaAutomatica extends javax.swing.JPanel {
   ...
   private final JTextField[][] listaTextFields;
   private final JSpinner[][] listaSpinners;
   
    public DietaAutomatica() {
        initComponents();
       String DATABASE_URL = null;
        ...
        anularDatosPaciente();
        listaTextFields = new JTextField[5][5]; // 5 días, 5 comidas por día
        listaSpinners = new JSpinner[5][5];  
        listaTextFields[0][0] = DesayunoDia1;
        listaTextFields[0][1] = AlmuerzoDia1;
    // ... Continuar con todos los días y comidas

        listaSpinners[0][0] = SpinnerDesayunoDia1;
        listaSpinners[0][1] = SpinnerAlmuerzoDia1;
               ...
               @Override
                   public void itemStateChanged(ItemEvent e) {
                       if (e.getStateChange() == ItemEvent.SELECTED) {
                           ...
                           try {
                               cargarDietaAutomatica();
                           } catch (SQLException ex) {
                               Logger.getLogger(DietaAutomatica.class.getName()).log(Level.SEVERE, null, ex);
                           }
                       }
                   }
           });
...
public void cargarDatosPaciente(String nombrePaciente) {
    ...
    try {
        ...
        if (rs.next()) {
            // Cargar datos del paciente en los JTextFields
            ...
            // Determinar el objetivo del paciente
            float pesoActual = rs.getFloat("pesoActual");
            float pesoBuscado = rs.getFloat("pesoBuscado");
            String objetivo = pesoBuscado > pesoActual ? "Subir de peso" : "Bajar de peso";

            // Cargar la dieta automáticamente
            cargarDietaAutomatica();
        }
...
public void cargarDietaAutomatica() throws SQLException {
   // Listas de JTextField y JSpinner para cada comida
    ...
    try {
        ...
        float pesoInicial = Float.parseFloat(outputPesoActual2.getText());
        float pesoDeseado = Float.parseFloat(outputPesoBuscado2.getText());
...
private void calcularPesoEnTotal(JTextField[][] comidas, JSpinner[][] spinners, JTextField outputPesoTotal) throws SQLException {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("DIETA AUTOMATICA");
